...
class ListingAdmin(admin.ModelAdmin):
    list_display = ('title', 'seller', 'city', 'state', 'price', 'is_approved')
    list_filter = ('is_approved', 'list_date')
    ...
    # fields = ['title', 'description', 'address', 'city', 'state', 'zip_code', 'price', 'bedrooms', 'bathrooms', 'square_feet', 'year_built', 'photo_main', 'photo_1', 'photo_2', 'photo_3', 'photo_4', 'photo_5', 'photo_6', 'is_approved']
